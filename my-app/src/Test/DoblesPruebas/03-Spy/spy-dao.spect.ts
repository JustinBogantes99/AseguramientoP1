...
export class DAO {
    ...
    insertarGrupo(idMovimiento:String, idZona:String, idRama:String, idGrupo:String, bMonitores:boolean, pNombre:String, idMonitor1:String, idMonitor2: string | null){
        if(!idMonitor2){
            idMonitor2 = "";
        }
